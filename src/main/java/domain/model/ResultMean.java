...
public class ResultMean {
    ...
    private String getResultInterpretation(int estimatedVocab) {
        ...
        // 300-699：小学高级
        vocabLevels.put(300, "经评估，您的词汇量达到小学高级水平，掌握了较多基础词汇。您能理解简单的英语日常用语。建议继续扩充词汇量，为初中英语学习做准备。");

        // 200-299：小学中级
        vocabLevels.put(200, "经评估，您的词汇量达到小学中级水平，已积累了一定的基础词汇。您能理解简单的课本内容。建议通过多样化学习继续积累词汇。");
    ...
    private String getLearningBucket(int estimatedVocab) {
        ...
        // 300-699：小学高级
        learningBuckets.put(300, "巩固小学高年级词汇，突破基础语法点。通过多样化练习提升理解能力，培养学习兴趣。坚持每日听读训练。");

        // 200-299：小学中级
        learningBuckets.put(200, "掌握小学中年级词汇，培养语音语感。通过趣味活动巩固知识，建立学习信心。完成基础听说读写练习。");
    ...
    private String getGradeLevelVersion0(int estimatedVocab) {
        ...
        gradeLevels.put(300, "小学高级水平");
        gradeLevels.put(200, "小学中级水平");
